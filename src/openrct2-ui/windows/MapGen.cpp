...
static rct_widget SimplexWidgets[] = {
    ...
    { WWT_CHECKBOX,         1,  104,    198,    190,    201,    STR_MAPGEN_OPTION_RANDOM_TERRAIN,                   STR_NONE },
    { WWT_FLATBTN,          1,  102,    148,    202,    237,    0xFFFFFFFF,                 STR_CHANGE_BASE_LAND_TIP },
    { WWT_FLATBTN,          1,  150,    196,    202,    237,    0xFFFFFFFF,                 STR_CHANGE_VERTICAL_LAND_TIP },

    { WWT_CHECKBOX,         1,  104,    198,    239,    250,    STR_NONE,                   STR_NONE },
