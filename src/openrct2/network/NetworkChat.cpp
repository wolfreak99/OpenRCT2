...
void NetworkChat::SetEnvironment(IPlatformEnvironment * env)
{
    _env = env;
}

bool NetworkChat::Init()
{
    if (!InitialiseWSA()) {
        return false;
    }
...
bool NetworkChat::BeginClient(const char* host, uint16 port)
{
...
bool NetworkChat::BeginServer(uint16 port, const char* address)
{
    Close();
    if (!Init())
        return false;
...
sint32 NetworkChat::GetMode()
{
    return mode;
}

sint32 NetworkChat::GetStatus()
{
    return status;
}

sint32 NetworkChat::GetAuthStatus()
{
...
uint32 NetworkChat::GetServerTick()
{
    return server_tick;
}

uint8 NetworkChat::GetPlayerID()
{
    return player_id;
}

void NetworkChat::Update()
{
    _closeLock = true;
...
std::vector<std::unique_ptr<NetworkPlayer>>::iterator NetworkChat::GetPlayerIteratorByID(uint8 id)
{
...
NetworkPlayer* NetworkChat::GetPlayerByID(uint8 id)
{
...
std::vector<std::unique_ptr<NetworkGroup>>::iterator NetworkChat::GetGroupIteratorByID(uint8 id)
{
...
NetworkGroup* NetworkChat::GetGroupByID(uint8 id)
{
...
const char* NetworkChat::FormatChat(NetworkPlayer* fromplayer, const char* text)
{
...
void NetworkChat::SendPacketToClients(NetworkPacket& packet, bool front, bool gameCmd)
{
...
bool NetworkChat::CheckSRAND(uint32 tick, uint32 srand0)
{
...
void NetworkChat::KickPlayer(sint32 playerId)
{
    for(auto it = client_connection_list.begin(); it != client_connection_list.end(); it++) {
...
void NetworkChat::SetPassword(const char* password)
{
    _password = password == nullptr ? "" : password;
}

void NetworkChat::ShutdownClient()
{
    if (GetMode() == NETWORK_MODE_CLIENT) {
...
std::string NetworkChat::GenerateAdvertiseKey()
{
...
const char *NetworkChat::GetMasterServerUrl()
{
...
NetworkGroup* NetworkChat::AddGroup()
{
...
void NetworkChat::RemoveGroup(uint8 id)
{
...
uint8 NetworkChat::GetGroupIDByHash(const std::string &keyhash)
{
...
uint8 NetworkChat::GetDefaultGroup()
{
    return default_group;
}

void NetworkChat::SetDefaultGroup(uint8 id)
{
    if (GetGroupByID(id)) {
        default_group = id;
    }
...
void NetworkChat::SetupDefaultGroups()
{
...
std::string NetworkChat::BeginLog(const std::string &directory, const std::string &filenameFormat)
{
    utf8 filename[256];
    time_t timer;
    time(&timer);
...
void NetworkChat::AppendLog(const std::string &logPath, const std::string &s)
{
...
void NetworkChat::BeginChatLog()
{
    auto directory = _env->GetDirectoryPath(DIRBASE::USER, DIRID::LOG_CHAT);
    _chatLogPath = BeginLog(directory, _chatLogFilenameFormat);
}

void NetworkChat::AppendChatLog(const std::string &s)
{
...
void NetworkChat::CloseChatLog()
{
}

void NetworkChat::BeginServerLog()
{
...
void NetworkChat::AppendServerLog(const std::string &s)
{
...
void NetworkChat::CloseServerLog()
{
...
void NetworkChat::Client_Send_TOKEN()
{
...
void NetworkChat::Client_Send_AUTH(const char* name, const char* password, const char* pubkey, const char *sig, size_t sigsize)
{
    std::unique_ptr<NetworkPacket> packet(NetworkPacket::Allocate());
...
void NetworkChat::Client_Send_OBJECTS(const std::vector<std::string> &objects)
{
...
void NetworkChat::Server_Send_TOKEN(NetworkConnection& connection)
{
    std::unique_ptr<NetworkPacket> packet(NetworkPacket::Allocate());
...
void NetworkChat::Server_Send_OBJECTS(NetworkConnection& connection, const std::vector<const ObjectRepositoryItem *> &objects) const
{
...
void NetworkChat::Server_Send_AUTH(NetworkConnection& connection)
{
...
void NetworkChat::Server_Send_MAP(NetworkConnection* connection)
{
...
uint8 * NetworkChat::save_for_network(size_t &out_size, const std::vector<const ObjectRepositoryItem *> &objects) const
{
...
void NetworkChat::Client_Send_CHAT(const char* text)
{
    std::unique_ptr<NetworkPacket> packet(NetworkPacket::Allocate());
...
void NetworkChat::Server_Send_CHAT(const char* text)
{
    std::unique_ptr<NetworkPacket> packet(NetworkPacket::Allocate());
    *packet << (uint32)NETWORK_COMMAND_CHAT;
    packet->WriteString(text);
...
void NetworkChat::Client_Send_GAMECMD(uint32 eax, uint32 ebx, uint32 ecx, uint32 edx, uint32 esi, uint32 edi, uint32 ebp, uint8 callback)
{
    std::unique_ptr<NetworkPacket> packet(NetworkPacket::Allocate());
...
void NetworkChat::Server_Send_GAMECMD(uint32 eax, uint32 ebx, uint32 ecx, uint32 edx, uint32 esi, uint32 edi, uint32 ebp, uint8 playerid, uint8 callback)
{
    std::unique_ptr<NetworkPacket> packet(NetworkPacket::Allocate());
    *packet << (uint32)NETWORK_COMMAND_GAMECMD << (uint32)gCurrentTicks << eax << (ebx | GAME_COMMAND_FLAG_NETWORKED)
...
void NetworkChat::Server_Send_TICK()
{
...
void NetworkChat::Server_Send_PLAYERLIST()
{
    std::unique_ptr<NetworkPacket> packet(NetworkPacket::Allocate());
...
void NetworkChat::Client_Send_PING()
{
    std::unique_ptr<NetworkPacket> packet(NetworkPacket::Allocate());
...
void NetworkChat::Server_Send_PING()
{
...
void NetworkChat::Server_Send_PINGLIST()
{
    std::unique_ptr<NetworkPacket> packet(NetworkPacket::Allocate());
...
void NetworkChat::Server_Send_SETDISCONNECTMSG(NetworkConnection& connection, const char* msg)
{
    std::unique_ptr<NetworkPacket> packet(NetworkPacket::Allocate());
...
void NetworkChat::Server_Send_GAMEINFO(NetworkConnection& connection)
{
    std::unique_ptr<NetworkPacket> packet(NetworkPacket::Allocate());
...
void NetworkChat::Server_Send_SHOWERROR(NetworkConnection& connection, rct_string_id title, rct_string_id message)
{
    std::unique_ptr<NetworkPacket> packet(NetworkPacket::Allocate());
...
void NetworkChat::Server_Send_GROUPLIST(NetworkConnection& connection)
{
    std::unique_ptr<NetworkPacket> packet(NetworkPacket::Allocate());
...
void NetworkChat::Server_Send_EVENT_PLAYER_JOINED(const char *playerName)
{
    std::unique_ptr<NetworkPacket> packet(NetworkPacket::Allocate());
...
void NetworkChat::Server_Send_EVENT_PLAYER_DISCONNECTED(const char *playerName, const char *reason)
{
    std::unique_ptr<NetworkPacket> packet(NetworkPacket::Allocate());
    *packet << (uint32)NETWORK_COMMAND_EVENT;
...
bool NetworkChat::ProcessConnection(NetworkConnection& connection)
{
    sint32 packetStatus;
    do {
...
void NetworkChat::ProcessPacket(NetworkConnection& connection, NetworkPacket& packet)
{
    uint32 command;
    packet >> command;
...
void NetworkChat::ProcessGameCommandQueue()
{
...
void NetworkChat::AddClient(ITcpSocket * socket)
{
...
void NetworkChat::RemoveClient(std::unique_ptr<NetworkConnection>& connection)
{
...
NetworkPlayer* NetworkChat::AddPlayer(const utf8 *name, const std::string &keyhash)
{
...
std::string NetworkChat::MakePlayerNameUnique(const std::string &name)
{
...
void NetworkChat::Client_Handle_TOKEN(NetworkConnection& connection, NetworkPacket& packet)
{
    utf8 keyPath[MAX_PATH];
    network_get_private_key_path(keyPath, sizeof(keyPath), gConfigNetwork.player_name);
    if (!platform_file_exists(keyPath)) {
...
void NetworkChat::Client_Handle_AUTH(NetworkConnection& connection, NetworkPacket& packet)
{
    uint32 auth_status;
...
void NetworkChat::Server_Client_Joined(const char* name, const std::string &keyhash, NetworkConnection& connection)
{
...
void NetworkChat::Server_Handle_TOKEN(NetworkConnection& connection, NetworkPacket& packet)
{
...
void NetworkChat::Client_Handle_OBJECTS(NetworkConnection& connection, NetworkPacket& packet)
{
...
void NetworkChat::Server_Handle_OBJECTS(NetworkConnection& connection, NetworkPacket& packet)
{
    uint32 size;
    packet >> size;
...
void NetworkChat::Server_Handle_AUTH(NetworkConnection& connection, NetworkPacket& packet)
{
...
void NetworkChat::Client_Handle_MAP(NetworkConnection& connection, NetworkPacket& packet)
{
    uint32 size, offset;
    packet >> size >> offset;
...
bool NetworkChat::LoadMap(IStream * stream)
{
    bool result = false;
    try
    {
...
bool NetworkChat::SaveMap(IStream * stream, const std::vector<const ObjectRepositoryItem *> &objects) const
{
    bool result = false;
...
void NetworkChat::Client_Handle_CHAT(NetworkConnection& connection, NetworkPacket& packet)
{
...
void NetworkChat::Server_Handle_CHAT(NetworkConnection& connection, NetworkPacket& packet)
{
    if (connection.Player) {
...
void NetworkChat::Client_Handle_GAMECMD(NetworkConnection& connection, NetworkPacket& packet)
{
    uint32 tick;
    uint32 args[7];
    uint8 playerid;
...
void NetworkChat::Server_Handle_GAMECMD(NetworkConnection& connection, NetworkPacket& packet)
{
    uint32 tick;
    uint32 args[7];
    uint8 playerid;
...
void NetworkChat::Client_Handle_TICK(NetworkConnection& connection, NetworkPacket& packet)
{
    uint32 srand0;
    uint32 flags;
...
void NetworkChat::Client_Handle_PLAYERLIST(NetworkConnection& connection, NetworkPacket& packet)
{
    uint8 size;
    packet >> size;
...
void NetworkChat::Client_Handle_PING(NetworkConnection& connection, NetworkPacket& packet)
{
    Client_Send_PING();
}

void NetworkChat::Server_Handle_PING(NetworkConnection& connection, NetworkPacket& packet)
{
...
void NetworkChat::Client_Handle_PINGLIST(NetworkConnection& connection, NetworkPacket& packet)
{
    uint8 size;
    packet >> size;
    for (uint32 i = 0; i < size; i++) {
...
void NetworkChat::Client_Handle_SETDISCONNECTMSG(NetworkConnection& connection, NetworkPacket& packet)
{
...
void NetworkChat::Server_Handle_GAMEINFO(NetworkConnection& connection, NetworkPacket& packet)
{
    Server_Send_GAMEINFO(connection);
}

void NetworkChat::Client_Handle_SHOWERROR(NetworkConnection& connection, NetworkPacket& packet)
{
...
void NetworkChat::Client_Handle_GROUPLIST(NetworkConnection& connection, NetworkPacket& packet)
{
    group_list.clear();
    uint8 size;
...
void NetworkChat::Client_Handle_EVENT(NetworkConnection& connection, NetworkPacket& packet)
{
    char text[256];
    uint16 eventType;
    packet >> eventType;
...
void NetworkChat::Client_Send_GAMEINFO()
{
...
void NetworkChat::Client_Handle_GAMEINFO(NetworkConnection& connection, NetworkPacket& packet)
{
...
void network_chat_show_connected_message()
{
    ...
    server.Name = "Server";
    const char * formatted = NetworkChat::FormatChat(&server, buffer);
    chat_history_add(formatted);
}
