...
// STR_0890    :<removed string - do not use>
    ...
    STR_DEMOLISH = 994,
    STR_DEMOLISH_RIDE_ID_NO_MONEY = 995,
...
// 5766 is unused
    ...
    STR_REFURBISH_RIDE_TIP = 6145,
    STR_CANT_REFURBISH_RIDE = 6146,
    STR_CANT_REFURBISH_NOT_NEEDED = 6147,
    STR_REFURBISH = 6148,
    STR_REFURBISH_RIDE = 6149,
    STR_REFURBISH_RIDE_ID_MONEY = 6150,
    STR_REFURBISH_RIDE_ID_NO_MONEY = 6151,
    STR_DEMOLISH_RIDE_ID_MONEY = 6152,
